...
class ArtByColorsComponent extends Component
{
    use WithPagination;
    public $pageSize=18;
    public $color_slug;
    ...
    public function render()
    {
        ...
        return view('livewire.art-by-colors-component',['products'=>$products,'categories'=>$categories, 'colors'=>$colors,'color_name'=>$color_name,'color'=>$color]);
    }
}
