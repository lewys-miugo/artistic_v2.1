<div>
    ...
    <div class="m-4 flex flex-col-12">
        ...
        <div class="m-2 ">
            <div>
                <p class="text-left text-xs text-[#6a767e]"><a href="/" class="uppercase">Home</a> > All Pieces</p>
            </div>
                            ...
                            <div class="flex flex-col m-2">
                                ...
                                <a href="{{route('product.details',['slug'=>$product->slug])}}">
                                        ...
                                        <div class="swiper-wrapper ">
                                                @if($product->image)
                                                    <div class="swiper-slide flex justify-center content-center m-auto"> 
                                                        <img src="{{asset('images/products')}}/{{$product->image}}" loading="lazy" alt="{{$product->name}}" class="h-64">
                                                    </div>
                                                @endif
                                    ...
                                    <div class="flex flex-row">
                                        <!-- <ul>
                                            category
                                            <li class="text-xs pl-2 text-[#46555f]">category</li>
                                            price
