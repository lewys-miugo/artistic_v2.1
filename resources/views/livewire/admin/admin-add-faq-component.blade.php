<div>
    ...
    <div class="mx-4">
        <p class="text-left text-xs text-[#6a767e]"><a href="/" class="uppercase">Home</a> > Admin > Add New FAQ</p>
    </div>

    <h1 class="text-center">Adding New FAQ</h1>
    ...
    <div class="mx-8">
        ...
        @endif
        <form class="max-w-md mx-auto" wire:submit.prevent="storeFaq" >
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <textarea id="answer" cols="30" rows="4" type="text" name="answer" class="w-full rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Enter Answer of the question above" wire:model="answer"></textarea>
                @error('answer')
                    <p class="text-white bg-red-300">{{$message}}</p>
                @enderror
            </div>
