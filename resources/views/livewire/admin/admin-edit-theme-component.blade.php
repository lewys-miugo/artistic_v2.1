<div>
    ...
    <div class="mx-4">
        <p class="text-left text-xs text-[#6a767e]"><a href="/" class="uppercase">Home</a> > Admin > Edit Theme</p>
    </div>
    ...
    <div class="mx-8">
        ...
        @endif
        <form class="max-w-md mx-auto" wire:submit.prevent="updateTheme">
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <input id="slug" type="text" name="slug" class="w-full rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Enter theme slug" wire:model="slug">
                @error('slug')
                    <p class="text-white bg-red-300">{{$message}}</p>
                @enderror
            </div>
